...
export const secretAlbums: Album[] = [
  {
    ...
    tracks: [
      { id: 's1-1', title: 'Portal Opens', duration: '2:13' },
      { id: 's1-2', title: 'Dungeon Crawl', duration: '3:47' },
      { id: 's1-3', title: 'Pixel Memories', duration: '4:05' },
      { id: 's1-4', title: '8-Bit Nightmare', duration: '3:22' },
      { id: 's1-5', title: 'Boss Fight', duration: '5:01' },
      { id: 's1-6', title: 'Game Over', duration: '1:58' },
    ],
  },
  {
    id: 'arcade-ghosts',
    ...
    tracks: [
      { id: 's2-1', title: 'Insert Coin', duration: '0:45' },
      { id: 's2-2', title: 'High Score', duration: '3:33' },
      { id: 's2-3', title: 'Ghost Mode', duration: '4:12' },
      { id: 's2-4', title: 'Retro Fever', duration: '3:28' },
      { id: 's2-5', title: 'Chiptune Dreams', duration: '4:45' },
      { id: 's2-6', title: 'Credits Roll', duration: '2:20' },
    ],
  },
];
